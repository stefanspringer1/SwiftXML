...
**This library is not in a “final” state yet,** i.e. there might be bugs or maybe breaking changes will happen. Also, when such a final state is reached, the library might be further developed using a new repository URL. Further notice will be added here. See [there](https://stefanspringer.com) for contact information.
