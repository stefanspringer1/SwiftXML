...
Suppose an element can have multiple `<metadata>` children, but for some reason only the first one is relevant, and you want to iterate over its `<item>` children:
