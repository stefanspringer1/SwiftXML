...
func content(including: (XContent) -> Bool) -> XContentSequence
```

The `including` version also stops where the condition is fullfilled, but _includes_ the according item.
