...
- As all namespace prefix definitions are being set at the root element, this silently changes, as soons as the document is serialized, the meaning of element names with according literal prefixes that before had been outside the scope of those definitions.
